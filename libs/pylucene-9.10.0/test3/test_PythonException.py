...
import sys, lucene, unittest, sysconfig
    ...
    if '-loop' in sys.argv:
        ...
        while True:
            try:
                ...
                pass
    elif sysconfig.get_config_var('Py_DEBUG') == 0:
         unittest.main()
    else:
        print("skipping test as it triggers assert in Objects/typeobject.c, line 3243, which is not expecting an error to be set")
