...
class SimpleGUI:
    ...
    def center_window(self, window_width=1000, window_height=850):
        """
        Center the window on the screen.
        :param window_width: window width
        :param window_height: window height
    ...
    def mark_as_relevant(self):
        ...
        """
        # relevant_docs = [checkbox.cget("text") for checkbox in self.result_checkboxes if checkbox.var.get() == 1]
        # print("Relevant documents selected:", relevant_docs)
        #
        # # Get indices of the selected relevant documents
        # relevant_indices = [self.document_titles.index(title) for title in relevant_docs]
        ...
        print("Relevant document indices selected:", relevant_indices)
